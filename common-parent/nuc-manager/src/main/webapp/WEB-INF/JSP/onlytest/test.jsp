        ...
        <div id="main">
            ...
            <div id="wrap">
               <div id="text">
                   ...
                   <br>
                    <span class="say"><span class="space"></span>this is test</span>
                    </div>
                </div>
                <div id="clock-box">
                    <a href="http://blog.csdn.net/wuxia2001" target="_blank">@nuc</a> 与 <a href="http://blog.csdn.net/wuxia2001" target="_blank">@test</a> 活着的
                        <div id="clock"></div>
                </div>
